...
(function(){
  ...
  if(abtn){
    ...
    /* Sound is ON by default: anyone who hasn't explicitly switched it off
       gets the anthem at their first click or keypress (the earliest moment
       browsers allow audio). An explicit "off" stays off. */
...
.hero .scrim{position:absolute;inset:0;background:
  linear-gradient(180deg,rgba(6,6,9,.40) 0%,rgba(6,6,9,.28) 42%,
    rgba(6,6,9,.62) 80%,var(--bg) 100%),
  radial-gradient(ellipse 900px 420px at 50% 0%,rgba(223,168,57,.14),transparent 70%)}
...
/* the headline runs translucent so the gameplay reads through the letters */
.hero .banner ~ .inner h1{color:rgba(246,243,232,.72);
  text-shadow:0 3px 30px rgba(0,0,0,.38)}
.hero .banner ~ .inner h1 em{color:rgba(233,181,69,.78)}
